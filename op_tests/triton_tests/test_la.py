...
@pytest.mark.parametrize(
    ...
    [
        # (False, 1, 64, 128, [16384], 128, 304, torch.float16, 128, 64, 1, 4),
        # (False, 1, 96, 128, [32768], 128, 304, torch.float16, 128, 64, 1, 4),
        # (True, 1, 64, 8192, [8192], 128, 304, torch.float16, 128, 64, 1, 4),
        # (True, 2, 64, 8192, [8192, 8192], 128, 304, torch.float16, 128, 64, 1, 4),
        # (True, 1, 64, 16384, [16384], 128, 304, torch.float16, 128, 64, 1, 4),
        # (True, 4, 32, 2048, [2048]*4, 128, 304, torch.float16, 128, 64, 1, 4)
        ...
        # (False, 1, 64, 128, [16384], 128, 304, torch.float16, 128, 64, 1, 4),
        # (False, 1, 96, 128, [32768], 128, 304, torch.float16, 128, 64, 1, 4),
        # (True, 1, 64, 8192, [8192], 128, 304, torch.float16, 128, 64, 2, 4),
        # (True, 2, 64, 8192, [8192, 8192], 128, 304, torch.float16, 128, 64, 2, 4),
        # (True, 1, 64, 16384, [16384], 128, 304, torch.float16, 128, 64, 2, 4),
        # (True, 2, 64, 16384, [16384, 16384], 128, 304, torch.float16, 128, 64, 2, 4),
        # (False, 2, 64, 8192, [8192, 8192], 128, 304, torch.float16, 128, 64, 1, 4),
        # (False, 2, 64, 16384, [16384, 16384], 128, 304, torch.float16, 128, 64, 1, 4),
        # (False, 2, 48, 16384, [16384, 16384], 128, 304, torch.float16, 128, 64, 1, 4),
